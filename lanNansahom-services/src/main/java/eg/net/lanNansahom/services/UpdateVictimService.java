...
public class UpdateVictimService extends AbstractService {
	...
	public void validateRequest(ServiceRequest serviceRequest) throws ServiceException {
		UpdateVictimsRequest request = (UpdateVictimsRequest) serviceRequest;
	...
	public ServiceResponse execute(ServiceRequest serviceRequest) throws ServiceException {
		UpdateVictimsRequest request = (UpdateVictimsRequest) serviceRequest;
		business.updateVictim(request.getVictim());
		return new UpdateVictimsResponse();
	}
}
